...
#define MTDPARTS_DEFAULT	"mtdparts=nor-flash:0x10000@0x000000(nsboot),0x40000@0x10000(boot),0x10000@0x50000(env),0x200000@0x60000(kernel),0x520000@0x260000(rootfs),-(rootfs_data)"
...
#define CONFIG_EXTRA_ENV_SETTINGS					 \
	...
	"bootargs=mem=64M gmmem=34M console=ttyS0,115200 user_debug=31 init=/init root=/dev/mtdblock4 rootfstype=squashfs mtdparts=nor-flash:0x10000@0x000000(nsboot),0x40000@0x10000(boot),0x10000@0x50000(env),0x200000@0x60000(kernel),0x520000@0x260000(rootfs),-(rootfs_data) \0" \
	"upgradefw=sf probe 0; tftpboot all.img; sf erase 0x0 0x1000000; sf write 0x02000000 0x0 0x1000000"
...
#define CONFIG_IPADDR                   192.168.1.220
